...
COPY ..\src\ServiceStack.Text\bin\Release\Signed\ServiceStack.Text.* ..\..\ServiceStack\lib\signed
COPY ..\src\ServiceStack.Text\bin\Release\Signed\ServiceStack.Text.* ..\..\ServiceStack.Redis\lib\signed
COPY ..\src\ServiceStack.Text\bin\Release\Signed\ServiceStack.Text.* ..\..\ServiceStack.OrmLite\lib\signed
